...
export function OrderStatusManager({
  ...
  return (
    <div className="bg-white border border-zinc-200 rounded-xl p-5 space-y-4 shadow-xs font-sans">
      ...
      {/* STATE A: Read-Only Display (Automated by Items) */}
      {!isEditing ? (
        ...
        /* STATE B: Manual Override Edit Mode */
        <div className="space-y-4 animate-fadeIn">
          <div className="bg-amber-50 border border-amber-200/60 p-3 rounded-lg flex items-start gap-2 text-amber-800 text-xs mb-2">
          ...
          <div className="pt-3 border-t border-zinc-100 flex items-center gap-2">
            ...
            {/* Critical Addition: Confirmation Dialog wrapping the Save Action */}
            <ConfirmationDialog
